...
Этот проект предназначен для конкретного случая: Apple iMac 27-inch, Mid 2011, Model Identifier `iMac12,2`, Board ID `Mac-942B59F58194171B`, на Linux Mint с доступным модулем `applesmc`.

Это не универсальный скрипт для всех Mac. Перед установкой обязательно проверь модель, датчики и fan-пути.
